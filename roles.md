# Shinobi V3 — Agent Roles (Bundles of Skills)

This document defines **agent roles** as bundles of skills required to build Shinobi V3’s **in-memory object graph kernel** that compiles to **Pulumi**, with **policy/config-driven** compliance.
