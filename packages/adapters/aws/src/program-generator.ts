...
export const OUTPUT_MAP: Record<
  string,
  ReadonlyArray<{ suffix: string; field: string }>
> = {
  "aws:lambda:Function": [{ suffix: "arn", field: "arn" }],
  "aws:sqs:Queue": [
    { suffix: "url", field: "url" },
    { suffix: "arn", field: "arn" },
  ],
  ...
  "aws:s3:Bucket": [
    { suffix: "bucket", field: "bucket" },
    { suffix: "arn", field: "arn" },
  ],
  "aws:apigatewayv2:Api": [
    { suffix: "id", field: "id" },
    { suffix: "url", field: "apiEndpoint" },
  ],
  "aws:sns:Topic": [{ suffix: "arn", field: "arn" }],
  "aws:cloudfront:Distribution": [
    { suffix: "domainName", field: "domainName" },
    { suffix: "arn", field: "arn" },
  ],
  ...
  "aws:sfn:StateMachine": [
    { suffix: "arn", field: "arn" },
    { suffix: "stateMachineArn", field: "stateMachineArn" },
  ],
  ...
  "aws:ecr:Repository": [
    { suffix: "repositoryUrl", field: "repositoryUrl" },
    { suffix: "arn", field: "arn" },
  ],
  "aws:ecs:Cluster": [
    { suffix: "arn", field: "arn" },
  ...
  "aws:eks:Cluster": [
    { suffix: "name", field: "name" },
    { suffix: "arn", field: "arn" },
    { suffix: "endpoint", field: "endpoint" },
  ],
  ...
  "aws:kms:Key": [
    { suffix: "arn", field: "arn" },
    { suffix: "keyId", field: "keyId" },
  ],
  "aws:kms:Alias": [{ suffix: "arn", field: "arn" }],
  "aws:elasticache:ReplicationGroup": [
    { suffix: "primaryEndpointAddress", field: "primaryEndpointAddress" },
    { suffix: "arn", field: "arn" },
  ],
  ...
  "aws:bedrock:Guardrail": [
    { suffix: "guardrailArn", field: "guardrailArn" },
    { suffix: "guardrailId", field: "guardrailId" },
  ],
  "aws:sagemaker:Model": [
    { suffix: "name", field: "name" },
    { suffix: "arn", field: "arn" },
  ...
  "aws:opensearch:Domain": [
    { suffix: "endpoint", field: "endpoint" },
    { suffix: "arn", field: "arn" },
    { suffix: "domainId", field: "domainId" },
  ],
  ...
  "aws:opensearchserverless:Collection": [
    { suffix: "collectionEndpoint", field: "collectionEndpoint" },
    { suffix: "arn", field: "arn" },
  ],
  ...
  "aws:rds:Cluster": [
    { suffix: "endpoint", field: "endpoint" },
    { suffix: "readerEndpoint", field: "readerEndpoint" },
    { suffix: "arn", field: "arn" },
  ],
  ...
  "aws:sagemaker:Pipeline": [
    { suffix: "pipelineName", field: "pipelineName" },
    { suffix: "arn", field: "arn" },
  ],
  "aws:msk:Cluster": [
    { suffix: "arn", field: "arn" },
    { suffix: "bootstrapBrokersTls", field: "bootstrapBrokersTls" },
    { suffix: "zookeeperConnectString", field: "zookeeperConnectString" },
  ],
  "aws:msk:Configuration": [
    { suffix: "arn", field: "arn" },
    { suffix: "latestRevision", field: "latestRevision" },
  ],
  ...
  "aws:ec2:Eip": [
    { suffix: "allocationId", field: "allocationId" },
    { suffix: "publicIp", field: "publicIp" },
  ],
  "aws:ec2:NatGateway": [
    { suffix: "id", field: "id" },
    { suffix: "publicIp", field: "publicIp" },
  ...
  "aws:route53:Zone": [
    { suffix: "zoneId", field: "zoneId" },
    { suffix: "nameServers", field: "nameServers" },
  ],
  ...
  for (const resource of sorted) {
    ...
    if (outputEntries) {
      for (const entry of outputEntries) {
        outputs[`${resource.name}-${entry.suffix}`] =
...
function topologicalSort(
  resources: ReadonlyArray<LoweredResource>,
