...
export class GuardDutyLowerer implements NodeLowerer {
  ...
  lower(node: Node, context: LoweringContext, _resolvedDeps: ResolvedDeps): ReadonlyArray<LoweredResource> {
    ...
    const findingPublishingFrequency = (props['findingPublishingFrequency'] as string) ?? 'FIFTEEN_MINUTES';
    ...
    resources.push({
      ...
      properties: {
        ...
        datasources: {
          ...
          malwareProtection: { scanEc2InstanceWithFindings: { ebsVolumes: { enable: malwareProtection } } },
        },
